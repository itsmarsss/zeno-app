...
use commands::{
    ...
    run_log_exercise_session, run_monitor_timeline, run_presence_check, run_python_session,
    run_session_history, run_update_settings, start_focus_stream, start_hr_stream, start_posture_stream,
