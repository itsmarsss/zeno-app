...
use commands::{
    ...
    run_log_exercise_session, run_monitor_timeline, run_overview_aggregates, run_presence_check,
    run_python_session, run_session_days, run_session_history, run_update_settings, start_focus_stream,
